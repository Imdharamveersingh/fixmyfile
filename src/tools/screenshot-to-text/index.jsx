  ...
  return (
    <div className="tool-page-container">
      ...
      <ToolDetailHeader
        ...
        description="Extract text instantly from screenshots and clipboard screen captures. Paste with Ctrl+V or upload your image. 100% private, zero cloud uploads."
      />
