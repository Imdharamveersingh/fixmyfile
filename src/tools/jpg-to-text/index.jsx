...
export default function JpgToTextTool() {
  ...
  useEffect(() => {
    document.title = 'JPG to Text (OCR) Online Free — Extract Text from JPEG | FixMyFile';
  }, []);
  ...
  const handleFileSelect = async (file) => {
    ...
    try {
      ...
      setErrorMessage(err.message || 'Failed to read JPEG image file.');
      ...
      <div className="tool-workspace">
        ...
        {!selectedFile && !extractedText && (
          ...
          >
            ...
            <ToolIcon icon="jpg-to-text" size={48} />
          </div>
            <h2 className="dropzone-title">Drop your JPG / JPEG image here</h2>
            <p className="dropzone-desc">
              Upload a JPG or JPEG document to extract text. Supported: .jpg, .jpeg (up to {formatBytes(MAX_IMAGE_FILE_SIZE)})
            </p>
            <button
              type="button"
            ...
            <p className="dropzone-guarantee">
              Your JPG documents are processed 100% locally in your browser. They are never sent to any server.
            </p>
          </div>
        )}
        ...
        {selectedFile && !extractedText && (
          <div className="file-active-card" id="jpg-to-text-active-card">
            ...
            {previewUrl && (
              <div className="ocr-preview-container">
                <img
                  id="jpg-to-text-preview"
                  src={previewUrl}
                  alt="JPG preview for text recognition"
            ...
            <div className="ocr-options-grid">
              <label className="ocr-option-checkbox">
                ...
                />
                <span>Contrast enhancement (recommended for scanned papers & receipts)</span>
              </label>
              ...
              >
                {isProcessing ? (
                  ...
                  <>
                    ...
                    <span>Extract Text from JPG</span>
                  </>
                )}
              </button>
              <button
        ...
        {extractedText !== null && (
          <div className="result-card" id="jpg-to-text-result">
            ...
            <p className="result-subtitle">
              Your JPEG document has been recognized directly in your browser.
            </p>
            ...
            <div className="ocr-result-wrap">
              ...
              <textarea
                ...
                placeholder="No text recognized in this JPG image."
                rows={10}
              />
            </div>
